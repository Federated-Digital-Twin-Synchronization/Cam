...
def create_3d_bbox(Id, mtl_prim, bbox_path='/bbox_'):

    cube_prim_path = bbox_path + str(Id)
...
def bbox_update(trans, Id, bbox_path='/bbox_'):
    cube_prim_path= bbox_path + str(Id)
    omni.kit.commands.execute(
        "IsaacSimTeleportPrim",
        prim_path=cube_prim_path,
        translation=(trans[0],trans[1],0.8),
    )
